...
name, surname, age = "Guillermo", "Garzón", 30
print("Mi nombre es {} {} y mi edad es {}".format(name, surname, age) + " años")
print("Mi nombre es %s %s y mi edad es %d" %(name, surname, age) + " años")
